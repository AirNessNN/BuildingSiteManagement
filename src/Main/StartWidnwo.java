...
public class StartWidnwo extends JFrame{
	...
	public void paint(Graphics g) {
		...
		g.drawImage(Util.getImage(Resource.getResource("欢迎界面.png")), 0, 0, null);
		Graphics2D g2d=(Graphics2D)g;
		g2d.setColor(Color.white);
		g2d.setFont(new Font(Resource.WEI_RUAN_YA_HEI, 0, 18));
		g2d.setRenderingHint(RenderingHints.KEY_TEXT_ANTIALIASING,RenderingHints.VALUE_TEXT_ANTIALIAS_ON);
		//绘制状态文字
		g2d.drawString(label.getText(), 30, 180);
		//绘制版本号
		g2d.setFont(new Font(Resource.WEI_RUAN_YA_HEI, 0, 15));
